...
const Breadcrumb = ({ pageName, enableBackButton, isAdministrator }: BreadcrumbProps) => {
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol className="flex items-center gap-6">
                    {enableBackButton && (
                        <li>
                            <span className="cursor-pointer" onClick={handleBackButtonClick}>
                                <svg fill="black" height="35px" width="35px" version="1.1" id="Capa_1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 219.151 219.151"><g
                    ...
                    <li>
                        {!isAdministrator?.isAdministrator ?
                            <Link className="font-medium" href="/">
                                Home /
                            </Link> : <Link className="font-medium" href="/admin">
                                Admin /
                            </Link>
                        }
                    </li>
