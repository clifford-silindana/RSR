...
import TableOccurrences from "@/components/Tables/TableOcurrences";
    ...
    const fetchOperatorApplications = async () => {
      try {
        if (!dataLoaded) {
          ...
          const data = await getOccurrenceBySearchCriteria(); //Permits
...
*/
  ...
  allApplications.forEach((application) => {
    ...
    applicationStatuses.push(application.occurrenceStatus.name);
  });
        ...
        <div className="col-span-12">
          ...
          {dataLoaded ? (
            <TableOccurrences
              ...
              pageProps={{
                heading: "",
                pageUrl: "/admin/occurence/application",
              }}
              people={officers}
