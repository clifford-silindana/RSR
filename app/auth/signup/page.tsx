...
export const metadata: Metadata = {
  title: "Signup Page | Next.js E-commerce Dashboards Template",
...
const SignUp: React.FC = () => {
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-boxdark-2 shadow-default dark:border-strokedark dark:bg-boxdark">
