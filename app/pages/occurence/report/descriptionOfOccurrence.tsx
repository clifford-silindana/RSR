...
const DescriptionOfOccurencePage = () => {
    ...
    const descriptionOfOccurenceList = [
        {
            name: "Derailment",
            id: 1
        },
    ...
    const [checkedState, setCheckedState] = useState(
        new Array(descriptionOfOccurenceList.length).fill(false)
    );
        ...
        <div>
            <div className="flex flex-wrap items-center">
                <label className="mb-3 block text-black dark:text-white">
                    Select Description Of Occurence:
                </label>
                <div style={{ marginLeft: 20, width: 900, display: 'flex', justifyContent: 'space-between' }}>
                    {descriptionOfOccurenceList.map(({ name, id }, index) => {
            ...
            <div>
                <label className="mb-3 block text-black dark:text-white">
                    Additional description of Occurence
                </label>
                <input
                    type="text"
                    placeholder="Additional description of Occurence"
...
export default DescriptionOfOccurencePage;
